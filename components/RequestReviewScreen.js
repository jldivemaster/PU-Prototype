  ...
  render() {
    return(
      <View>
        ...
        <SubmitButton callback={this.onSubmit} newRoute='LaunchBeacon' alertMessage='Beacon Has Been Launched' buttonText='Submit Request/Launch Beacon (Leave BeaconStack)' nav={this.props.navigation}/>
